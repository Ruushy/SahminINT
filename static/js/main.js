...
(function () {
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (e.key === '?' && e.target.tagName !== 'INPUT' && e.target.tagName !== 'TEXTAREA') {
      showToast('Shortcuts: / Search, g+d Dashboard, g+t Targets, g+s Subdomains, g+r Reports', 'info');
    }
    ...
    if (document._gPressed) {
      ...
      var map = { d: '/api/dashboard/', t: '/api/targets/', s: '/api/recon/subdomains/', r: '/api/reporting/' };
      var url = map[e.key];
